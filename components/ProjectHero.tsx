...
export default function ProjectHero() {
  ...
  const { elementRef: projectsRef, blurClass: projectsBlur } = useBlurOnScroll<HTMLParagraphElement>(0.1);
        ...
        <ContainerLayout className="pt-20 sm:pt-24 md:pt-28" paddingX="px-6 xl:px-[48px] lg:px-[48px]">
          ...
          <div className="block lg:hidden">
            ...
            <div className="mb-6">
              <p 
                ref={projectsRef}
                className={`text-[#8D957E] font-gc-palioka text-[16px] mb-2 font-normal transition-all duration-700 ease-out ${projectsBlur}`}
              >
                Our projects
              </p>
              <h1 
