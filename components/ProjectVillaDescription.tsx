            ...
            <div className="flex flex-col sm:flex-row justify-between items-start mb-4">
              <div className="mb-4 w-full">
                <div className="flex justify-between items-start mb-2">
                  <h2 className="font-gc-palioka text-[20px] sm:text-[28px] text-black leading-tight">
                    The Agasti west
                  </h2>
                  <button 
                    onClick={() => toggleVillaDetails('zenith')}
                    className="bg-[#8D957E] text-white text-[8px] font-bold tracking-wider hover:bg-[#7A8470] transition-colors duration-300 flex items-center justify-center rounded-[4px]" 
                    style={{ width: '113px', height: '30px' }}
                  >
                    EXPLORE VILLA
            ...
            {!expandedVilla && (
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div>
                  ...
                  <span className="text-[#8D957E]-500 text-[14px]">653 sq yds</span>
                </div>
                <div>
                  <span className="text-black text-[16px] font-bold block mb-1">Property type:</span>
                  <span className="text-[#8D957E]-500 text-[14px]">Villa</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="text-[#8D957E]-500 text-[14px]">Ongoing</span>
                </div>
              </div>
            )}
            ...
            {expandedVilla === 'zenith' && (
              <>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div>
                    <span className="text-black text-[16px] font-bold block mb-1">Property size:</span>
                    <span className="text-gray-500 text-[14px]">653 sq yds</span>
                  </div>
                  <div>
                    <span className="text-black text-[16px] font-bold block mb-1">Property type:</span>
                    <span className="text-gray-500 text-[14px]">Villa</span>
                  </div>
                  <div>
                    <span className="text-black text-[16px] font-bold block mb-1">Year of build:</span>
                  ...
                  <div>
                    <span className="text-black text-[16px] font-bold block mb-1">Property status:</span>
                    <span className="text-gray-500 text-[14px]">Ongoing</span>
                  </div>
                </div>
          ...
          {!expandedVilla && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div>
                  <span className="text-black text-[16px] font-bold block mb-1">Property size:</span>
                  <span className="text-gray-500 text-[14px]">915 sq yds</span>
                </div>
                <div>
                  <span className="text-black text-[16px] font-bold block mb-1">Property type:</span>
                  <span className="text-gray-500 text-[14px]">Villa</span>
